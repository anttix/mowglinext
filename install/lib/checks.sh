...
check_firmware() {
  ...
  status_data="$(
    docker_cmd exec mowgli-ros2 bash -lc \
      "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && timeout 5 ros2 topic echo /hardware_bridge/status --once 2>/dev/null" \
      2>/dev/null || echo ""
  )"
...
check_gps() {
  ...
  if [[ "${HARDWARE_BACKEND:-mowgli}" == "mavros" ]]; then
    ...
    mavros_state="$(
      docker_cmd exec mowgli-ros2 bash -lc \
        "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && timeout 5 ros2 topic echo /mavros/state --once 2>/dev/null" \
        2>/dev/null || echo ""
    )"
    ...
    mavros_global="$(
      docker_cmd exec mowgli-ros2 bash -lc \
        "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && timeout 5 ros2 topic echo /mavros/global_position/global --once 2>/dev/null" \
        2>/dev/null || echo ""
    )"
    ...
    rtcm_info="$(
      docker_cmd exec mowgli-ros2 bash -lc \
        "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && ros2 topic info /rtcm 2>/dev/null" \
        2>/dev/null || echo ""
    )"
  ...
  fix_data="$(
    docker_cmd exec mowgli-ros2 bash -lc \
      "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && timeout 5 ros2 topic echo /gps/fix --once 2>/dev/null" \
      2>/dev/null || echo ""
  )"
...
check_lidar() {
  ...
  scan_check="$(
    docker_cmd exec mowgli-ros2 bash -lc \
      "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && ros2 topic info /scan 2>/dev/null" \
      2>/dev/null || echo ""
  )"
...
check_gui() {
  ...
  fg_info="$(
    docker_cmd exec mowgli-ros2 bash -lc \
      "source /opt/mowgli_underlay.sh && source /ros2_ws/install/setup.bash && ros2 node list 2>/dev/null" \
